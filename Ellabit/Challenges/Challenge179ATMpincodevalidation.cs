...
{
    public class Challenge179ATMpincodevalidation : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
Empty strings must return false.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { {"String", "Comparision"}, { "Level" , "2"} };
