...
{
    public class Challenge056Returnastringasaninteger : IChallenge, IChallengeTestCode
    {
...
All numbers will be positive.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "String", "Conversion" }, { "Int", "Parse" }, { "Level", "1" } };
