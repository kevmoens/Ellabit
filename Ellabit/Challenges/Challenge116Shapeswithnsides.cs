...
{
    public class Challenge116Shapeswithnsides : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
The challenge is intended to be completed without conditionals(it would take too long)!";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { {"Array", "Index" }, {"Logic", "If" }, {"Level", "2" } };
