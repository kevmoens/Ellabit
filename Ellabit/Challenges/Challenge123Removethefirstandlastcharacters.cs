...
{
    public class Challenge123Removethefirstandlastcharacters : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
If the string is 2 or fewer characters long, return the string itself(See example #4).";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "String", "Substring" }, { "Level", "1"} };
