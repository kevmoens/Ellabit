...
{
    public class Challenge173Thecollatzconjecture : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
collatz(10) ➞ 6
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Int",  "Parity"}, { "Level", "2" } };
