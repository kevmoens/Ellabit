...
{
    public class Challenge085Addupthenumbersfromasinglenumber : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
expect any positive number between 1 and 1000.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Math", "Add"}, { "Level", "2"} };
