...
{
    public class Challenge091Thestudyofwumbology : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
Wumbo(""WUMBOLOGY"") ➞ ""WUWBOLOGY""
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "String", "Replacements" }, { "Level", "2" } };
