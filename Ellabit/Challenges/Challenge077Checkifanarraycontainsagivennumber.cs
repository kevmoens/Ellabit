...
{
    public class Challenge077Checkifanarraycontainsagivennumber : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
don't forget to return the result.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Array", "Bool" }, { "Level", "2" } };
