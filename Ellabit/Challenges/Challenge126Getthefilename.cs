...
{
    public class Challenge126Getthefilename : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
For simplicity, all paths will include forward slashes.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "String", "Path.GetFileName()" }, { "Level", "1"} };
