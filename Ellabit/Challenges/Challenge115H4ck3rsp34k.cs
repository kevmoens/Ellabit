...
{
    public class Challenge115H4ck3rsp34k : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
In order to work properly, the function should replace all ""a""s with 4, ""e""s with 3, ""i""s with 1, ""o""s with 0, and ""s""s with 5.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { {"String", "Replace" }, {"Logic", "If" }, { "Level", "2" } };
