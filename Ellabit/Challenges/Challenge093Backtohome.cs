...
{
    public class Challenge093Backtohome : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
BackToHome(""NEESSW"") ➞ false
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Directions", "Journey" }, { "Level", "2" } };
