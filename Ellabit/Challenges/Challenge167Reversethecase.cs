...
{
    public class Challenge167Reversethecase : IChallenge, IChallengeTestCode
    {
...
ReverseCase(""sPoNtAnEoUs"") ➞ ""SpOnTaNeOuS""
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "String", "ReverseCase" }, { "Level", "2" } };
