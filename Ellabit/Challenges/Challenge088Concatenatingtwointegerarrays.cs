...
{
    public class Challenge088Concatenatingtwointegerarrays : IChallenge, IChallengeTestCode
    {
...
don't forget to return the result.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Concatenate", "Arrays"}, { "Level", "2"} };
