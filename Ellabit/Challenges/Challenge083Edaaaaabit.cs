...
{
    public class Challenge083Edaaaaabit : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
The test will also contains negative values, in this case you should return an empty string";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "String", "Int" }, { "Level", "2" } };
