...
{
    public class Challenge067Concatenatingfirstandlastcharacterofastring : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
There is no empty string.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "String", "Concatenate" }, { "Level", "2" } };
