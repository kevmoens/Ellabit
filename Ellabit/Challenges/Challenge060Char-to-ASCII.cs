...
{
    public class Challenge060ChartoASCII : IChallenge, IChallengeTestCode
    {
...
don't forget to return the result.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Char", "Conversion" }, { "Level", "1" } };
