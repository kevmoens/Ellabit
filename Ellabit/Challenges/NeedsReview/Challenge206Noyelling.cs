...
examples
noyelling(""Create a function that transforms sentences ending with multiple question marks or exclamation marks ! into a sentence only ending with one without changing punctuation in the middle of the sentences.
