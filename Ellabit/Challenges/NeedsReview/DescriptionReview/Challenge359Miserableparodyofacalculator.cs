...
{
    public class Challenge359Miserableparodyofacalculator : IChallenge
    {
        public string? Header { get; set; } = "Miserable parody of a calculator";
...
";
        public string? Description { get; set; } = @"Create a function that will handle simple math expressions. the input is an expression in the form of a string.
