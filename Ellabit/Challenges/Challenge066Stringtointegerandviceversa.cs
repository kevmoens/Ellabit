...
{
    public class Challenge066Stringtointegerandviceversa : IChallenge, IChallengeTestCode
    {
...
Don't forget to return the result.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Data Type", "Conversion" }, { "Level", "1" } };
