...
{
    public class Challenge087Smashfactor : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
All values will be valid (so no dividing by zero).";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Math", "Rounding" }, { "Level", "1" } };
