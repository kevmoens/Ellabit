...
{
    public class Challenge076Reverseanarray : IChallenge, IChallengeTestCode
    {
...
don't forget to return the result.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Arrays", "Foreach" }, { "Level", "2" } };
