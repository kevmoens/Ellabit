...
{
    public class Challenge065AddSubtractMultiplyorDivide : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
The function should return either ""added"", ""subtracted"", ""divided"", ""multiplied"" or ""none"".";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Statements", "Else" }, { "Level", "2" } };
