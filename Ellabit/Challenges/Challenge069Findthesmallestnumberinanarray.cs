...
{
    public class Challenge069Findthesmallestnumberinanarray : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
test cases contain decimals.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Array", "Index" }, { "Level", "2" } };
