...
{
    public class Challenge171Convertallarrayitemstostring : IChallenge, IChallengeTestCode
    {
...
parsearray([]) ➞ [])
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Array", "Parse"}, { "Level", "3" } };
