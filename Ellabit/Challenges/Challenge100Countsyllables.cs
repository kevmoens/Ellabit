...
{
    public class Challenge100Countsyllables : IChallenge, IChallengeBlockly, IChallengeTestCode
    {
...
Don't forget to return the result.";
        ...
        private Dictionary<string, string> _tags = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase) { { "Syllables", "Math" }, { "Level", "2" } };
